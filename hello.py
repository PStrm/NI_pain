...
# JE TO ZBASTLENY JAK NIKDY ALE NECHCE SE MI PREMYSLET NEMUZEM NIC
# start: python psychrometr.py

# start: co chcete udelat:
# 1. Merit
# 2. Podat OZNUK (oznameni o ukonceni studia)
# 3. Poslat zpravu autorovi teto ******* aplikace
# 4. Konec

# Merit: Kolik sekund chcete namerit?
# Merit: Jak se ma jmenovat vysledny soubor?
# Merit: stisknete y a enter az budete rdy

# vypise to mereni
# vyexportuje se soubor
Z = 273.15
timing = 15
...
# experimentalky workflow: ukazat ruzny mereni vlhkosti, k cemu to muze byt. vysvetlit co je wbgt. Namerit odpar z mokryho hadru a volne hladiny, nemuzemnic?
# cil: porovnat rychlost odparu z ruznych veci: mokrej hard, volna hladina, 
